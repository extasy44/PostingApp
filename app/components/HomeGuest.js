...
const HomeGuest = () => {
    ...
    switch (action.type) {
      ...
      case "usernameUniqueResults":
        if (action.value) {
          ...
          draft.username.message = "The username already exist";
        } else {
      ...
      case "emailUniqueResults":
        if (action.value) {
          ...
          draft.email.message = "The email already exist";
        } else {
  ...
  return (
    <Page title="Welcome to SaySay" wide={true}>
      <div className="row align-items-center">
        <div className="col-lg-6 py-3 py-md-5">
          <h2 className="display-3">Remember Writing?</h2>
